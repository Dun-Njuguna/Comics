...
public class Constants {
    public static final String marvelKey = BuildConfig.MarvelKey;
    public static final String MarvelHash = BuildConfig.MarvelHash;
    public static final String TimeStamp = BuildConfig.TimeStamp;
